...
public class Clients extends TableImpl<ClientsRecord> {
    ...
    private static final long serialVersionUID = -186617017;
    ...
    /**
     * The column <code>public.CLIENTS.FIRST_NAME</code>.
     */
    public final TableField<ClientsRecord, String> FIRST_NAME = createField("FIRST_NAME", org.jooq.impl.SQLDataType.VARCHAR(250).nullable(false), this, "");
    ...
    public List<UniqueKey<ClientsRecord>> getKeys() {
        return Arrays.<UniqueKey<ClientsRecord>>asList(Keys.CLIENTS_PKEY);
    }
    ...
    public List<ForeignKey<ClientsRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<ClientsRecord, ?>>asList(Keys.CLIENTS__CARD_ID);
    }

    public Table_1 table_1() {
        return new Table_1(this, Keys.CLIENTS__CARD_ID);
    }
